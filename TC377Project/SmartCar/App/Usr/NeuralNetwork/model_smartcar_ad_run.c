...
#define FC1_zzdbg_3_productShf        23
...
#define FC7_SB                        7
#define FC7_SO                        11
#define FC7_zzdbg_2_SH_WT             11
#define FC7_zzdbg_3_productShf        21
...
{ 
    ...
    // Block 1: Dense - dense_8
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC1weit/*weit*/, FC1_IY/*8*/, FC1_OY/*96*/, FC1_SB/*10*/
        , FC1_SO/*13*/, cg_FC1bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);

    // Block 1: Activation - activation_7
    arm_relu_q15((int16_t*)img_buffer1/*1*/, (uint32_t)(ACT1_IX * ACT1_IY * ACT1_IC)/*1x96x1*/);

    // Block 2: Dense - dense_9
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*96*/, FC2_OY/*64*/, FC2_SB/*8*/
    ...
    // Block 5: Dense - dense_12
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC5weit/*weit*/, FC5_IY/*32*/, FC5_OY/*32*/, FC5_SB/*8*/
    ...
    // Block 6: Dense - dense_13
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC6weit/*weit*/, FC6_IY/*32*/, FC6_OY/*16*/, FC6_SB/*8*/
    ...
    // Block 7: Dense - dense_14
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC7weit/*weit*/, FC7_IY/*16*/, FC7_OY/*1*/, FC7_SB/*7*/
        , FC7_SO/*11*/, cg_FC7bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);
