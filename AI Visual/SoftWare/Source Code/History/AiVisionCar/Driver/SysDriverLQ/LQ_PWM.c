...
void PWM_InitConfig(PWM_Type *base, pwm_submodule_t subModule, pwm_channels_t pwm_channels, uint16_t Frequency)
{
    ...
    //管脚复用选择
    PWM_InitPins(base, subModule, pwm_channels); 
...
/**
  ...
  * @date     2019/5/23 星期四
  */
inline void PWM_SetDuty(PWM_Type *base, pwm_submodule_t subModule, pwm_channels_t pwm_channels, uint16_t duty)
{
...
/**
  ...
  * @date     2019/5/23 星期四
  */
inline void PWM_SetABDuty(PWM_Type *base, pwm_submodule_t subModule, uint16_t dutyA, uint16_t dutyB)
{
