...
#include <stdint.h>
#include "cmsisnn.h"
//#include "tricore_math.h"
//#include "tricore_nnfunctions.h"
...
{ 
    ...
    // Block 1: Dense - dense_5
    tricore_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC1weit/*weit*/, FC1_IY/*7*/, FC1_OY/*140*/, FC1_SB/*6*/
        , FC1_SO/*6*/, cg_FC1bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);

    // Block 1: Activation - activation_3
    aia_nn_activations_direct_q15((int16_t*)img_buffer1/*1*/, ACT1_OY/*140*/, ACT1_AA/*2*/, TRICORE_TANH, 14);

    // Block 2: Dense - dense_6
    tricore_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*140*/, FC2_OY/*100*/, FC2_SB/*11*/
        , FC2_SO/*10*/, cg_FC2bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

    // Block 2: Activation - activation_4
    aia_nn_activations_direct_q15((int16_t*)img_buffer0/*0*/, ACT2_OY/*100*/, ACT2_AA/*2*/, TRICORE_TANH, 14);

    // Block 3: Dense - dense_7
    tricore_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC3weit/*weit*/, FC3_IY/*100*/, FC3_OY/*40*/, FC3_SB/*14*/
    ...
    // Block 4: Dense - dense_8
    tricore_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC4weit/*weit*/, FC4_IY/*40*/, FC4_OY/*1*/, FC4_SB/*9*/
