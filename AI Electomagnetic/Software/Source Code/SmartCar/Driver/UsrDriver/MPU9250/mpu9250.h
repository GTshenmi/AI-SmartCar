...
#ifndef DRIVER_USRDRIVER_MPU9250_MPU9250_H_
#define DRIVER_USRDRIVER_MPU9250_MPU9250_H_
...
uint8_t MPU9250_Init(void *config);
short MPU_Get_Temperature(void);
uint8_t MPU_Get_Gyroscope(float *gx,float *gy,float *gz);
uint8_t MPU_Get_Accelerometer(float *ax,float *ay,float *az);
uint8_t MPU_Get_Magnetometer(float *mx,float *my,float *mz);

#endif /* DRIVER_USRDRIVER_MPU9250_MPU9250_H_ */
