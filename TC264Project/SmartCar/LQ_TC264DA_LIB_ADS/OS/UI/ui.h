...
typedef struct
{
        ...
        /*舵机部分*/
        sint16_t *Angle;         /*要设置的舵机转速(原数据)*/
        float    *NAngle;        /*要设置的舵机转速(归一化)*/

        float    *Bias;

        float    *SPID_Kp;       /*电机PID参数*/
        float    *SPID_Ki;       /*电机PID参数*/
        float    *SPID_Kd;       /*电机PID参数*/
        float    *SPID_Result;   /*电机PID输出*/

        uint16_t *S_PwmDuty;     /*电机占空比*/
