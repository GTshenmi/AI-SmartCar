...
#define AT_DTCRAM_SECTION(func) __attribute__((section("DTCRAMAccess"))) __align(64) func
#define AT_OCRAM_SECTION(func)  __attribute__((section("OCRAMAccess")))  __align(64) func
#elif(defined(__GNUC__))
#define AT_ITCRAM_SECTION(func) __attribute__((section("ITCRAMAccess"))) func
