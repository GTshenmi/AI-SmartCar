...
typedef struct key
{
    ...
    public
        ...
        void (*PressedCallBack)(struct key *self,void *data);    /*回调函数(按下一次)*/
        void (*LongPressedCallBack)(struct key *self,void *data);/*回调函数(长按)*/

        void (*BindUsrData)(struct key *self,void *data);
