...
void UI_Init ()
{
    ...
    KEY[2].PressedCallBack = cancelPressedCallBack;
    KEY[3].PressedCallBack = confirmPressedCallBack;
    KEY[4].PressedCallBack = pageUpPressedCallBack;
    KEY[4].LongPressedCallBack = pageUpLongPressedCallBack;
    KEY[5].PressedCallBack = pageDownPressedCallBack;
    KEY[5].LongPressedCallBack = pageDownLongPressedCallBack;
...
void cursorDownPressedCallBack (key_t *self, void *argv, uint16_t argc) // TODO test: 更改光标指向 下降
{
    if(SettingPage.GetStatus(SettingPage.Self)){
