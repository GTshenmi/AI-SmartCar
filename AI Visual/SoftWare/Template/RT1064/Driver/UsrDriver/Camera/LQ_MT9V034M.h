...
/* FLEXIO CAMERA 接口 */
#define FLEXIO_CAMERA_MT9V034   //flexio 使用MT9V034

#ifdef FLEXIO_CAMERA_MT9V034
#define FLEXIO_CAMERA_FPS  100
#define APP_FLEXIO_CAMERA_WIDTH  (FLEXIO_IMAGEW)
#define APP_FLEXIO_CAMERA_HEIGHT (FLEXIO_IMAGEH) 

#define  Use_FLEXIO_ROWS  120    //使用图像高度
#define  Use_FLEXIO_Line  160    //使用图像宽度
