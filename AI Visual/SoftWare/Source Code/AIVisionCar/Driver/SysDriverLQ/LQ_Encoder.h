...
/**********************************  ENC(引脚复用) *******************************************************/
//     ENC输入通道        端口    可选范围                       建议
#define ENC1_PHASE_A       B1      //XBARA
#define ENC1_PHASE_B       B6      //XBARA

#define ENC2_PHASE_A       A11     //XBARA
#define ENC2_PHASE_B       B11     //XBARA

#define ENC3_PHASE_A       H1      //XBARA
#define ENC3_PHASE_B       E4      //XBARA

#define ENC4_PHASE_A       M11     //XBARA
#define ENC4_PHASE_B       G11     //XBARA
...
/**
  ...
  * @date     2019/6/12 星期三
  */
void ENC_InitConfig(ENC_Type *base, bool direction);
...
/*!
  ...
  * @date     2019/10/9 星期三
  */
short ENC_GetValue(ENC_Type *base);
