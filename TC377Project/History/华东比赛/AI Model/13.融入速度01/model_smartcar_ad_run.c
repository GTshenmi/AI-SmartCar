...
extern const int16_t cg_FC1weit[]; // 864 - Co, Di: (96, 9)
...
{ 
    ...
    memcpy(img_buffer0, in_buf, 18);
    // Block 1: Dense - dense_5
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC1weit/*weit*/, FC1_IY/*9*/, FC1_OY/*96*/, FC1_SB/*9*/
