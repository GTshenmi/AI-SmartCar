...
#define FC6_SB                        9
#define FC6_SO                        10
#define FC6_zzdbg_2_SH_WT             10
#define FC6_zzdbg_3_productShf        20
...
#define FC7_SB                        10
#define FC7_SO                        14
#define FC7_zzdbg_2_SH_WT             14
#define FC7_zzdbg_3_productShf        24
#define FC7_zzdbg_4_SB_AMP            14
...
extern const int16_t cg_FC3weit[]; // 3072 - Co, Di: (48, 64)
extern const int16_t cg_FC3bias[]; // 48
extern const int16_t cg_FC4weit[]; // 1536 - Co, Di: (32, 48)
extern const int16_t cg_FC4bias[]; // 32
extern const int16_t cg_FC5weit[]; // 1024 - Co, Di: (32, 32)
...
{ 
    ...
    // Block 1: Dense - dense_8
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC1weit/*weit*/, FC1_IY/*8*/, FC1_OY/*96*/, FC1_SB/*8*/
    ...
    // Block 2: Dense - dense_9
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*96*/, FC2_OY/*64*/, FC2_SB/*7*/
    ...
    // Block 3: Dense - dense_10
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC3weit/*weit*/, FC3_IY/*64*/, FC3_OY/*48*/, FC3_SB/*8*/
        , FC3_SO/*10*/, cg_FC3bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);

    // Block 3: Activation - activation_9
    arm_relu_q15((int16_t*)img_buffer1/*1*/, (uint32_t)(ACT3_IX * ACT3_IY * ACT3_IC)/*1x48x1*/);

    // Block 4: Dense - dense_11
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC4weit/*weit*/, FC4_IY/*48*/, FC4_OY/*32*/, FC4_SB/*10*/
        , FC4_SO/*11*/, cg_FC4bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

    // Block 4: Activation - activation_10
    arm_relu_q15((int16_t*)img_buffer0/*0*/, (uint32_t)(ACT4_IX * ACT4_IY * ACT4_IC)/*1x32x1*/);

    // Block 5: Dense - dense_12
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC5weit/*weit*/, FC5_IY/*32*/, FC5_OY/*32*/, FC5_SB/*9*/
    ...
    // Block 6: Dense - dense_13
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC6weit/*weit*/, FC6_IY/*32*/, FC6_OY/*16*/, FC6_SB/*9*/
        , FC6_SO/*10*/, cg_FC6bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);
    ...
    // Block 7: Dense - dense_14
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC7weit/*weit*/, FC7_IY/*16*/, FC7_OY/*1*/, FC7_SB/*10*/
        , FC7_SO/*14*/, cg_FC7bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);
