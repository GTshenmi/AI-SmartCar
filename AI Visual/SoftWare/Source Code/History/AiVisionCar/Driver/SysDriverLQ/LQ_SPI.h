...
/**********************************  SPI(引脚复用) *******************************************************/
//     IIC管脚        端口        可选范围                   建议
#define SPI1_SCK      A2          //A2  J4                   A2 接外部SDRAM                 
#define SPI1_SDI      E1          //E1  K1                   E1 接外部SDRAM                  
#define SPI1_SDO      D1          //D1  J1                   D1 接外部SDRAM
#define SPI1_CS0      C6          //J3  C6                   C6 接外部SDRAM
...
/**
  ...
  * @date     2019/6/3 星期一
  */
void SPI_MasterInitConfig(LPSPI_Type * base, uint8_t cs_num, uint8_t mode, uint32_t baudrate);
