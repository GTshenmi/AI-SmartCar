...
#define FC2_zzdbg_3_productShf        18
...
#define FC3_SB                        8
#define FC3_SO                        8
#define FC3_zzdbg_2_SH_WT             8
#define FC3_zzdbg_3_productShf        18
...
{ 
    ...
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*96*/, FC2_OY/*64*/, FC2_SB/*7*/
        , FC2_SO/*8*/, cg_FC2bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

    // Block 2: Activation - activation_5
    arm_relu_q15((int16_t*)img_buffer0/*0*/, (uint32_t)(ACT2_IX * ACT2_IY * ACT2_IC)/*1x64x1*/);

    // Block 3: Dense - dense_7
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC3weit/*weit*/, FC3_IY/*64*/, FC3_OY/*32*/, FC3_SB/*8*/
        , FC3_SO/*8*/, cg_FC3bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);
    ...
    // Block 4: Dense - dense_8
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC4weit/*weit*/, FC4_IY/*32*/, FC4_OY/*1*/, FC4_SB/*8*/
