...
extern const int16_t cg_FC4weit[]; // 64 - Co, Di: (1, 64)
...
{ 
    ...
    // Block 1: Dense - dense_8
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC1weit/*weit*/, FC1_IY/*8*/, FC1_OY/*128*/, FC1_SB/*8*/
    ...
    // Block 2: Dense - dense_9
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*128*/, FC2_OY/*96*/, FC2_SB/*7*/
    ...
    // Block 4: Activation - re_lu_2
    aia_relu8_q15((int16_t*)img_buffer1/*1*/, (uint32_t)(ACT4_IX * ACT4_IY * ACT4_IC)/*1x64x1*/, ACT4_AI);

    // Block 4: Dense - dense_11
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC4weit/*weit*/, FC4_IY/*64*/, FC4_OY/*1*/, FC4_SB/*8*/
