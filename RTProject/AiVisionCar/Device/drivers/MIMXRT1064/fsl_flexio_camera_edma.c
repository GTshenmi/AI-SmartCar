...
/*<! 传输完成标志位 */
bool flexio_camera_edma_transfer_ok = false;
                                           ...
                                           flexio_camera_transfer_t *xfer)
{
    ...
    else
    {
        ...
        /* Prepare transfer. */
        EDMA_PrepareTransfer(&xferConfig, (void *)FLEXIO_CAMERA_GetRxBufferAddress(base), 4, (void *)xfer->dataAddress,
                             4, 4, xfer->dataNum, kEDMA_PeripheralToMemory);
